...
<table>
    ...
    <tr><td><div id="header" class='section'><table>
                    ...
                    <tr><td class='text data' colspan='5'><?php echo generate_form_field($manual_layouts['date_created'], array_key_exists('date_created', $xyzzy) ? $xyzzy['date_created'] :date('Y-m-d H:i:s')); ?></td><!-- called consumeRows 515--> <!-- Exiting not($fields) and generating 0 empty fields --></tr>
                </table>
<tr><td colspan='5'>&nbsp;</td></tr>
