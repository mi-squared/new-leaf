...
function intake_report( $pid, $encounter, $cols, $id) {
    ...
    $htmlcss = "
        ...
        .currentMedications{
         ...
         .familyAndSocial{
            display: grid;
            grid-template-columns: 400px 200px 50px 150px;
            grid-template-rows: auto;
            row-gap:1ch;
    ...
    $data .= PrintoutHelper::generate_title( 'header3 oneToThreeText', "Client Acknowledgement") ;
 ...
 <div></div> <div></div> <div></div>";
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['medication_info_from']);
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_physical_stature']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Hygiene") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_hygiene']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Apparent Age") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_apparent_age']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Dress") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_dress_appearance']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Posture") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_posture_appearance']);
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_consciousness_activity']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Motor Activity") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_motor_activity']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Eye Contact") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_eye_contact']);

    $data .= PrintoutHelper::generate_title( 'header2 mhheadertitle', "Attitude")  ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_attitude']); //todo: genCheckbox
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_speech_production']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Tone") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_speech_tone']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Rate") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_speech_rate']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Other") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_speech_other']);

    $data .= PrintoutHelper::generate_title( 'header2 mhheadertitle oneToThreeText', "Mood") ;
    $data .= PrintoutHelper::generate_value('oneToThreeText', $patient_data['mental_status_mood']); //todo: genCheckbox

    $data .= PrintoutHelper::generate_title( 'header2 mhheadertitle oneToThreeText', "Affect") ;
    $data .= PrintoutHelper::generate_value('oneToThreeText', $patient_data['mental_status_affect']); //todo: genCheckbox

    $data .= PrintoutHelper::generate_title( 'header2 mhheadertitle oneToThreeText', "Thought Process") ;
    $data .= PrintoutHelper::generate_value('oneToThreeText', $patient_data['mental_status_thought_process']); //todo: genCheckbox
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_hallucinations']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Other Perpetual Distortions") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_other_distortions']);
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_delusions']);

    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Other Abnormal Thoughts") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_abnormal_other']);
    ...
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_orientation']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Intelligence") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_intelligence']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Abstraction") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_abstraction']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Insight") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_insight']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Memory Impaired") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_memory_impaired']);
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Attention Concentration Impaired") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_attention_concentration']);
 ;
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle', "Judgement Impaired") . "" ;
    $data .= PrintoutHelper::generate_value('', $patient_data['mental_status_judgment_impaired']);
    $data .= "</div>"; //mentalStatus

    $data .= "<div class = 'familyAndSocial'>";
    $data .= PrintoutHelper::generate_title( 'header2 mhtitle', "Medication History")  .  "<div></div><div></div> <div></div> ";
    ...
    $data .= PrintoutHelper::generate_title( 'header2 mhtitle oneThruFiveText', "Educational/Employment History");
    ...
    $data .= PrintoutHelper::generate_title( 'header2 mhtitle oneToThreeText', "Educational/Employment History");
    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle ', "Skills/Ability") . "" ;
    $data .= PrintoutHelper::generate_value('twoThruFiveText', $patient_data['needs_assessment_skills_ability']);

    $data .= PrintoutHelper::generate_title( 'header4 mhheadertitle ', "Resource Needs") . "" ;
    $data .= PrintoutHelper::generate_value('twoThruFiveText', $patient_data['needs_resources']);
